...
class PowerFlow:
    ...
    def _get_power_specs(self, circuit):
        """
        ...
        Args:
            circuit: Circuit object exposing buses, generators, and loads dictionaries.
    ...
    def _compute_mismatch(self, buses, ybus_np, angles, voltages, p_spec, q_spec):
        """
        ...
        Args:
            buses      : dict[str, Bus] — dictionary of buses in order
    ...
    def solve(self, circuit, ybus=None, tol=1e-3, max_iter=50):
        """
        ...
        Args:
            ...
            ybus     : pd.DataFrame or np.ndarray (N x N, complex) — Y-bus matrix.
                       Optional; defaults to circuit.y_bus if not provided.
        ...
        p_spec, q_spec = self._get_power_specs(circuit)
        ...
        for iteration in range(max_iter):
            ...
            f = self._compute_mismatch(buses, ybus_np, angles, voltages, p_spec, q_spec)
